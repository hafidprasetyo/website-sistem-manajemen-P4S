...
<div class="flex flex-wrap justify-center mt-4">
    <div class="p-4 w-full max-w-sm mb-3 bg-white rounded-md border border-gray-200 shadow-md sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
        <h4 class="text-1xl font-bold uppercase text-center mb-2">Tambah Data Peternakan</h4>
        <form action="{{ route('peternakan.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if($errors->any())
