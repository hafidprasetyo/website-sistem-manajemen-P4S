...
<div class="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        <img class="mx-auto max-w-lg h-auto mt-5" src="{{url('')}}/assets/images/{{$bibitmusiman->image}}" width="300px" height="400px" alt="">
    <div class="p-11">
    <h4 class="text-1xl font-bold uppercase text-center mb-2">{{ $bibitmusiman->name}}</h4>
    <form action="bibitmusiman" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="harga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama Bibit Musiman Yang Dibeli</label>
                <input type="text" id="harga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-72 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="namabibitmusiman" required="">
            </div> 
            <div class="mb-3">
                <label for="harga" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Jumlah Bibit Musiman Yang Dibeli</label>
                <input type="text" id="harga" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-72 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="jumlahbibitmusiman" required="">
            </div> 
