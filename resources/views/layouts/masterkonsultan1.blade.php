...
<hr class="my-4 md:min-w-full" />
    ...
    <ul>
        <li class="items-center">
            <a href="{{ route('konsultan.index') }}" class="text-xs uppercase py-3 font-bold flex text-blue-500 hover:text-blue-600">
        ...
        <li class="items-center">
            <a href="{{ route('pelatihan.index') }}" class="text-xs uppercase py-3 font-bold flex text-blueGray-700 hover:text-blueGray-500">
    ...
    <div class="relative md:ml-64 bg-tree">
                <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
                    <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
                        <a class="text-gray-900 text-sm uppercase hidden lg:inline-block font-semibold">Data Pelatihan</a >
